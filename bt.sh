...
wget -q -O/etc/trackers https://raw.githubusercontent.com/Vahid-Spacer/blockpublictorrent-iptables/main/trackers
...
curl -s -LO https://raw.githubusercontent.com/Vahid-Spacer/blockpublictorrent-iptables/main/hostsTrackers
